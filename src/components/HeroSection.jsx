    ...
    <div className="container max-w-4xl text-left px-2 pr-25 sm:px-6 lg:ml-24 z-10 text-white">
        <div className="space-y-1">
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight">
                ...
                <span className=" block text-[#FA8655] opacity-0 animate-fade-in-delay-4 font-extrabold tracking-wide "> <img className="w-100 m:w-100 lg:w-100" src="Projects/logo 2.png" alt="aaaaa" /></span>
            </h1>
