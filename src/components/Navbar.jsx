...
useEffect(() => {
  ...
  className={cn(
    ...
    isScrolled
      ? "top-4 w-[92%] max-w-8xl py-3 bg-glass/20 backdrop-blur-xl rounded-full shadow-lg scale-[0.98]"
...
>
  ...
  className="text-xl font-bold text-primary flex items-center cursor-pointer pl-4"
>

            <img
  src="Projects/logo 3.png"
  alt="LazyGraphite Logo"
  className={cn(
    "h-11.5 md:h-11.5 w-auto transition-all duration-300",
  )}
/>
  ...
  />
            ...
            {navItems.map((item) => (
              <a
                ...
                className={cn(
  "relative z-10 px-4 py-1.5 text-sm font-semibold transition-colors duration-300",
  !isScrolled
